...
class VMTasks(vm_utils.VMScenario):
    ...
    def windows_performance_test(self, image, flavor,
        ...
        # We need to set the MaxMemoryPerShell in order to be able to
        # use a higher number for the memory test
